...
> 当前版本：`0.1.0` 可构建 MVP。Mac 接收端自动化测试和 Android 单元测试已通过；真机上的六个购物 App 验收需在小米 17 上完成。
...
2. 扫描 Mac 上的配对二维码，只应由本 App 打开 `ordercapture://pair` 链接。
3. 在快捷设置中添加“提取页面”磁贴，或使用 Android 无障碍按钮。

## 使用流程

1. 打开订单详情，点击磁贴/无障碍按钮；或从商购 App 的分享面板选择本 App。
